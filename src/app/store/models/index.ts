 ...
 * The advantage of this design decision is that we only need to import one file / module wherever models in this folder are required, thus limiting the number of import statements clogging other parts of the application
 *
 */
