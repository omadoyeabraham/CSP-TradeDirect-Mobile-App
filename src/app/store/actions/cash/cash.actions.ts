...
export const SAVE_CASH_ACCOUNT_CASH_STATEMENTS =
  "[CASH] Save the cash statements for a cash statements";
...
export class saveCashAccountCashStatements implements Action {
  readonly type = SAVE_CASH_ACCOUNT_CASH_STATEMENTS;
  constructor(
    public payload: {
      cashAccountName: string;
      statements: Array<ICashStatement>;
    }
  ) {}
}
...
export class CashActionsDispatcher {
  ...
  saveCashAccountCashStatements(payload: {
    cashAccountName: string;
    statements: Array<ICashStatement>;
  }) {}
}
